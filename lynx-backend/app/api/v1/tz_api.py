...
def _demo_other_docs_response() -> dict:
    return {
        "summary": (
            ...
            "Основные решения:\n"
            "- Запроектирована система хозяйственно-питьевого водоснабжения В1 (DN250 ввод).\n"
            "- Противопожарный водопровод В2.1–В2.7 с кольцеванием и пожарными гидрантами.\n"
            "- Реализованы системы хозяйственно-бытовой и производственной канализации К1, К2 с самотечными выпусками; "
            "применяются трубопроводы диаметром 50–150 мм.\n"
            "- В качестве материалов трубопроводов используются полипропиленовые трубы для внутренней канализации "
            "и стальные трубы для систем водоснабжения.\n"
            "- Предусмотрена тепловая изоляция трубопроводов: 13 мм для систем холодного водоснабжения "
            "и 20 мм для систем горячего водоснабжения и циркуляции.\n"
            "- Проектом также определены основные требования к монтажу инженерных систем, "
            "способам прокладки трубопроводов и обеспечению их эксплуатационной надёжности."
        ),
