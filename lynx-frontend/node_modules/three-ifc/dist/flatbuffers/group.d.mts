...
import { InstancedMesh } from './instanced-mesh.mjs';
import './geometry.mjs';
import './material.mjs';
import './mesh-instance.mjs';
import './color.mjs';
...
declare class Group {
    ...
    static startGroup(builder: flatbuffers.Builder): void;
    static addInstancedMeshes(builder: flatbuffers.Builder, instancedMeshesOffset: flatbuffers.Offset): void;
    static createInstancedMeshesVector(builder: flatbuffers.Builder, data: flatbuffers.Offset[]): flatbuffers.Offset;
    static startInstancedMeshesVector(builder: flatbuffers.Builder, numElems: number): void;
