...
import { SpatialStructureNode } from './spatial-structure-node.js';

declare class SpatialStructure {
    ...
    static addNode(builder: flatbuffers.Builder, nodeOffset: flatbuffers.Offset): void;
