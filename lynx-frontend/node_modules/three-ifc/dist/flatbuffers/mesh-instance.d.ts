...
declare class MeshInstance {
    ...
    static startMeshInstance(builder: flatbuffers.Builder): void;
    static addId(builder: flatbuffers.Builder, idOffset: flatbuffers.Offset): void;
    static addExpressId(builder: flatbuffers.Builder, expressId: bigint): void;
    static addTransformationMatrix(builder: flatbuffers.Builder, transformationMatrixOffset: flatbuffers.Offset): void;
    ...
    static startTransformationMatrixVector(builder: flatbuffers.Builder, numElems: number): void;
