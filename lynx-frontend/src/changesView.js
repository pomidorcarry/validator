            ...
            if (data.problems) {
                data.problems.forEach(function(p, i) {
                    ...
                    _availableFixes.push({
                        ...
                        element_ids: eids,
                        cube_ids: p.cube_ids || (p.cube_id ? [p.cube_id] : []),
                ...
                if (data.issues) {
                    data.issues.forEach(function(issue, i) {
                        ...
                        _availableFixes.push({
                            ...
                            cube_ids: issue.cube_ids || (issue.cube_id ? [issue.cube_id] : []),
    ...
    if (_availableFixes.length === 0) {
        ...
        if (aiFixes.length) {
            ...
            aiFixes.forEach(function(fix, i) {
                ...
                var cubeStr = (fix.cube_ids || []).length ? fix.cube_ids.join(', ') : (fix.cube_id ? fix.cube_id : '');
                    ...
                    '<div class="changes-fix-card">' +
                        ...
                        '<div class="changes-fix-body">' +
                            ...
                            '<div class="changes-fix-meta">' +
                                ...
                                (cubeStr ? '<span class="changes-fix-id" style="font-size:11px;color:#f59e0b">Revit id: ' + window.escHtml(cubeStr) + '</span>' : '') +
